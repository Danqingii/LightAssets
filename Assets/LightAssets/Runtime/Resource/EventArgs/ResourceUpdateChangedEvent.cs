namespace LightAssets
{
    ...
    /// 资源更新改变事件。
    /// </summary>
    public sealed class ResourceUpdateChangedEvent : AEventArgs
    {
        /// <summary>
        /// 初始化资源更新改变事件的新实例。
        /// </summary>
        public ResourceUpdateChangedEvent()
        {
            Name = null;
            DownloadPath = null;
            DownloadUri = null;
        ...
        public static ResourceUpdateChangedEvent Create(string name, string downloadPath, string downloadUri, int currentLength, int compressedLength)
        {
            ResourceUpdateChangedEvent e = ReferencePool.Acquire<ResourceUpdateChangedEvent>();
            e.Name = name;

...
namespace GameFrameworkAsset
{
    ...
    internal sealed partial class ObjectPoolManager :  IObjectPoolManager
    {
        ...
        private readonly Dictionary<TypeNamePair, AObjectPool> m_ObjectPools;
        private readonly List<AObjectPool> m_CachedAllObjectPools;
        private readonly Comparison<AObjectPool> m_ObjectPoolComparer;
        ...
        {
            m_ObjectPools = new Dictionary<TypeNamePair, AObjectPool>();
            m_CachedAllObjectPools = new List<AObjectPool>();
        ...
        {
            foreach (KeyValuePair<TypeNamePair, AObjectPool> objectPool in m_ObjectPools)
            {
        ...
        public bool HasObjectPool<T>() where T : AObject
        {
        ...
        public bool HasObjectPool(Type objectType)
        {
            ...
            if (!typeof(AObject).IsAssignableFrom(objectType))
            {
        ...
        /// <returns>是否存在对象池。</returns>
        public bool HasObjectPool<T>(string name) where T : AObject
        {
        ...
        /// <returns>是否存在对象池。</returns>
        public bool HasObjectPool(Predicate<AObjectPool> condition)
        {
            if (condition == null)
            {
        ...
        public IObjectPool<T> GetObjectPool<T>() where T : AObject
        {
        ...
        /// <param name="objectType">对象类型。</param>
        /// <returns>要获取的对象池。</returns>
        public AObjectPool GetObjectPool(Type objectType)
        {
            if (objectType == null)
            {
                throw new Exception("Object type is invalid.");
        ...
        /// <param name="name">对象池名称。</param>
        /// <returns>要获取的对象池。</returns>
        public IObjectPool<T> GetObjectPool<T>(string name) where T : AObject
        {
        ...
        /// <param name="name">对象池名称。</param>
        /// <returns>要获取的对象池。</returns>
        public AObjectPool GetObjectPool(Type objectType, string name)
        {
            if (objectType == null)
            {
                throw new Exception("Object type is invalid.");
        ...
        /// <param name="condition">要检查的条件。</param>
        /// <returns>要获取的对象池。</returns>
        public AObjectPool GetObjectPool(Predicate<AObjectPool> condition)
        {
            if (condition == null)
            {
                throw new Exception("Condition is invalid.");
        ...
        /// <param name="condition">要检查的条件。</param>
        /// <returns>要获取的对象池。</returns>
        public AObjectPool[] GetObjectPools(Predicate<AObjectPool> condition)
        {
            if (condition == null)
            {
                throw new Exception("Condition is invalid.");
            ...
            List<AObjectPool> results = new List<AObjectPool>();
            foreach (KeyValuePair<TypeNamePair, AObjectPool> objectPool in m_ObjectPools)
            {
                if (condition(objectPool.Value))
                {
        ...
        public void GetObjectPools(Predicate<AObjectPool> condition, List<AObjectPool> results)
        {
            if (condition == null)
            {
                throw new Exception("Condition is invalid.");
        ...
        public AObjectPool[] GetAllObjectPools()
        {
        ...
        public void GetAllObjectPools(List<AObjectPool> results)
        {
        ...
        /// <returns>所有对象池。</returns>
        public AObjectPool[] GetAllObjectPools(bool sort)
        {
            if (sort)
            {
                List<AObjectPool> results = new List<AObjectPool>();
            ...
            {
                int index = 0;
                AObjectPool[] results = new AObjectPool[m_ObjectPools.Count];
                foreach (KeyValuePair<TypeNamePair, AObjectPool> objectPool in m_ObjectPools)
                {
        ...
        /// <param name="sort">是否根据对象池的优先级排序。</param>
        /// <param name="results">所有对象池。</param>
        public void GetAllObjectPools(bool sort, List<AObjectPool> results)
        {
            if (results == null)
            {
                throw new Exception("Results is invalid.");
        ...
        public IObjectPool<T> CreateSingleSpawnObjectPool<T>() where T : AObject
        {
        ...
        /// <param name="objectType">对象类型。</param>
        /// <returns>要创建的允许单次获取的对象池。</returns>
        public AObjectPool CreateSingleSpawnObjectPool(Type objectType)
        {
        ...
        /// <param name="name">对象池名称。</param>
        /// <returns>要创建的允许单次获取的对象池。</returns>
        public IObjectPool<T> CreateSingleSpawnObjectPool<T>(string name) where T : AObject
        {
        ...
        /// <param name="name">对象池名称。</param>
        /// <returns>要创建的允许单次获取的对象池。</returns>
        public AObjectPool CreateSingleSpawnObjectPool(Type objectType, string name)
        {
        ...
        /// <returns>要创建的允许单次获取的对象池。</returns>
        public IObjectPool<T> CreateSingleSpawnObjectPool<T>(int capacity) where T : AObject
        {
        ...
        /// <param name="capacity">对象池的容量。</param>
        /// <returns>要创建的允许单次获取的对象池。</returns>
        public AObjectPool CreateSingleSpawnObjectPool(Type objectType, int capacity)
        {
        ...
        /// <returns>要创建的允许单次获取的对象池。</returns>
        public IObjectPool<T> CreateSingleSpawnObjectPool<T>(float expireTime) where T : AObject
        {
        ...
        /// <param name="expireTime">对象池对象过期秒数。</param>
        /// <returns>要创建的允许单次获取的对象池。</returns>
        public AObjectPool CreateSingleSpawnObjectPool(Type objectType, float expireTime)
        {
        ...
        /// <param name="capacity">对象池的容量。</param>
        /// <returns>要创建的允许单次获取的对象池。</returns>
        public IObjectPool<T> CreateSingleSpawnObjectPool<T>(string name, int capacity) where T : AObject
        {
        ...
        /// <param name="capacity">对象池的容量。</param>
        /// <returns>要创建的允许单次获取的对象池。</returns>
        public AObjectPool CreateSingleSpawnObjectPool(Type objectType, string name, int capacity)
        {
        ...
        /// <param name="expireTime">对象池对象过期秒数。</param>
        /// <returns>要创建的允许单次获取的对象池。</returns>
        public IObjectPool<T> CreateSingleSpawnObjectPool<T>(string name, float expireTime) where T : AObject
        {
        ...
        /// <param name="expireTime">对象池对象过期秒数。</param>
        /// <returns>要创建的允许单次获取的对象池。</returns>
        public AObjectPool CreateSingleSpawnObjectPool(Type objectType, string name, float expireTime)
        {
        ...
        /// <param name="expireTime">对象池对象过期秒数。</param>
        /// <returns>要创建的允许单次获取的对象池。</returns>
        public IObjectPool<T> CreateSingleSpawnObjectPool<T>(int capacity, float expireTime) where T : AObject
        {
        ...
        /// <param name="expireTime">对象池对象过期秒数。</param>
        /// <returns>要创建的允许单次获取的对象池。</returns>
        public AObjectPool CreateSingleSpawnObjectPool(Type objectType, int capacity, float expireTime)
        {
        ...
        /// <returns>要创建的允许单次获取的对象池。</returns>
        public IObjectPool<T> CreateSingleSpawnObjectPool<T>(int capacity, int priority) where T : AObject
        {
        ...
        /// <param name="priority">对象池的优先级。</param>
        /// <returns>要创建的允许单次获取的对象池。</returns>
        public AObjectPool CreateSingleSpawnObjectPool(Type objectType, int capacity, int priority)
        {
        ...
        /// <param name="priority">对象池的优先级。</param>
        /// <returns>要创建的允许单次获取的对象池。</returns>
        public IObjectPool<T> CreateSingleSpawnObjectPool<T>(float expireTime, int priority) where T : AObject
        {
        ...
        /// <param name="priority">对象池的优先级。</param>
        /// <returns>要创建的允许单次获取的对象池。</returns>
        public AObjectPool CreateSingleSpawnObjectPool(Type objectType, float expireTime, int priority)
        {
        ...
        /// <param name="expireTime">对象池对象过期秒数。</param>
        /// <returns>要创建的允许单次获取的对象池。</returns>
        public IObjectPool<T> CreateSingleSpawnObjectPool<T>(string name, int capacity, float expireTime) where T : AObject
        {
        ...
        /// <param name="expireTime">对象池对象过期秒数。</param>
        /// <returns>要创建的允许单次获取的对象池。</returns>
        public AObjectPool CreateSingleSpawnObjectPool(Type objectType, string name, int capacity, float expireTime)
        {
        ...
        /// <param name="priority">对象池的优先级。</param>
        /// <returns>要创建的允许单次获取的对象池。</returns>
        public IObjectPool<T> CreateSingleSpawnObjectPool<T>(string name, int capacity, int priority) where T : AObject
        {
        ...
        /// <param name="priority">对象池的优先级。</param>
        /// <returns>要创建的允许单次获取的对象池。</returns>
        public AObjectPool CreateSingleSpawnObjectPool(Type objectType, string name, int capacity, int priority)
        {
        ...
        /// <param name="priority">对象池的优先级。</param>
        /// <returns>要创建的允许单次获取的对象池。</returns>
        public IObjectPool<T> CreateSingleSpawnObjectPool<T>(string name, float expireTime, int priority) where T : AObject
        {
        ...
        /// <param name="priority">对象池的优先级。</param>
        /// <returns>要创建的允许单次获取的对象池。</returns>
        public AObjectPool CreateSingleSpawnObjectPool(Type objectType, string name, float expireTime, int priority)
        {
        ...
        /// <param name="priority">对象池的优先级。</param>
        /// <returns>要创建的允许单次获取的对象池。</returns>
        public IObjectPool<T> CreateSingleSpawnObjectPool<T>(int capacity, float expireTime, int priority) where T : AObject
        {
        ...
        /// <param name="priority">对象池的优先级。</param>
        /// <returns>要创建的允许单次获取的对象池。</returns>
        public AObjectPool CreateSingleSpawnObjectPool(Type objectType, int capacity, float expireTime, int priority)
        {
        ...
        /// <param name="priority">对象池的优先级。</param>
        /// <returns>要创建的允许单次获取的对象池。</returns>
        public IObjectPool<T> CreateSingleSpawnObjectPool<T>(string name, int capacity, float expireTime, int priority) where T : AObject
        {
        ...
        /// <param name="priority">对象池的优先级。</param>
        /// <returns>要创建的允许单次获取的对象池。</returns>
        public AObjectPool CreateSingleSpawnObjectPool(Type objectType, string name, int capacity, float expireTime, int priority)
        {
        ...
        /// <param name="priority">对象池的优先级。</param>
        /// <returns>要创建的允许单次获取的对象池。</returns>
        public IObjectPool<T> CreateSingleSpawnObjectPool<T>(string name, float autoReleaseInterval, int capacity, float expireTime, int priority) where T : AObject
        {
        ...
        /// <param name="priority">对象池的优先级。</param>
        /// <returns>要创建的允许单次获取的对象池。</returns>
        public AObjectPool CreateSingleSpawnObjectPool(Type objectType, string name, float autoReleaseInterval, int capacity, float expireTime, int priority)
        {
        ...
        public IObjectPool<T> CreateMultiSpawnObjectPool<T>() where T : AObject
        {
        ...
        /// <param name="objectType">对象类型。</param>
        /// <returns>要创建的允许多次获取的对象池。</returns>
        public AObjectPool CreateMultiSpawnObjectPool(Type objectType)
        {
        ...
        /// <param name="name">对象池名称。</param>
        /// <returns>要创建的允许多次获取的对象池。</returns>
        public IObjectPool<T> CreateMultiSpawnObjectPool<T>(string name) where T : AObject
        {
        ...
        /// <param name="name">对象池名称。</param>
        /// <returns>要创建的允许多次获取的对象池。</returns>
        public AObjectPool CreateMultiSpawnObjectPool(Type objectType, string name)
        {
        ...
        /// <param name="capacity">对象池的容量。</param>
        /// <returns>要创建的允许多次获取的对象池。</returns>
        public IObjectPool<T> CreateMultiSpawnObjectPool<T>(int capacity) where T : AObject
        {
        ...
        /// <param name="capacity">对象池的容量。</param>
        /// <returns>要创建的允许多次获取的对象池。</returns>
        public AObjectPool CreateMultiSpawnObjectPool(Type objectType, int capacity)
        {
        ...
        /// <param name="expireTime">对象池对象过期秒数。</param>
        /// <returns>要创建的允许多次获取的对象池。</returns>
        public IObjectPool<T> CreateMultiSpawnObjectPool<T>(float expireTime) where T : AObject
        {
        ...
        /// <param name="expireTime">对象池对象过期秒数。</param>
        /// <returns>要创建的允许多次获取的对象池。</returns>
        public AObjectPool CreateMultiSpawnObjectPool(Type objectType, float expireTime)
        {
        ...
        /// <param name="capacity">对象池的容量。</param>
        /// <returns>要创建的允许多次获取的对象池。</returns>
        public IObjectPool<T> CreateMultiSpawnObjectPool<T>(string name, int capacity) where T : AObject
        {
        ...
        /// <param name="capacity">对象池的容量。</param>
        /// <returns>要创建的允许多次获取的对象池。</returns>
        public AObjectPool CreateMultiSpawnObjectPool(Type objectType, string name, int capacity)
        {
        ...
        /// <param name="expireTime">对象池对象过期秒数。</param>
        /// <returns>要创建的允许多次获取的对象池。</returns>
        public IObjectPool<T> CreateMultiSpawnObjectPool<T>(string name, float expireTime) where T : AObject
        {
        ...
        /// <param name="expireTime">对象池对象过期秒数。</param>
        /// <returns>要创建的允许多次获取的对象池。</returns>
        public AObjectPool CreateMultiSpawnObjectPool(Type objectType, string name, float expireTime)
        {
        ...
        /// <param name="expireTime">对象池对象过期秒数。</param>
        /// <returns>要创建的允许多次获取的对象池。</returns>
        public IObjectPool<T> CreateMultiSpawnObjectPool<T>(int capacity, float expireTime) where T : AObject
        {
        ...
        /// <param name="expireTime">对象池对象过期秒数。</param>
        /// <returns>要创建的允许多次获取的对象池。</returns>
        public AObjectPool CreateMultiSpawnObjectPool(Type objectType, int capacity, float expireTime)
        {
        ...
        /// <param name="priority">对象池的优先级。</param>
        /// <returns>要创建的允许多次获取的对象池。</returns>
        public IObjectPool<T> CreateMultiSpawnObjectPool<T>(int capacity, int priority) where T : AObject
        {
        ...
        /// <param name="priority">对象池的优先级。</param>
        /// <returns>要创建的允许多次获取的对象池。</returns>
        public AObjectPool CreateMultiSpawnObjectPool(Type objectType, int capacity, int priority)
        {
        ...
        /// <param name="priority">对象池的优先级。</param>
        /// <returns>要创建的允许多次获取的对象池。</returns>
        public IObjectPool<T> CreateMultiSpawnObjectPool<T>(float expireTime, int priority) where T : AObject
        {
        ...
        /// <param name="priority">对象池的优先级。</param>
        /// <returns>要创建的允许多次获取的对象池。</returns>
        public AObjectPool CreateMultiSpawnObjectPool(Type objectType, float expireTime, int priority)
        {
        ...
        /// <param name="expireTime">对象池对象过期秒数。</param>
        /// <returns>要创建的允许多次获取的对象池。</returns>
        public IObjectPool<T> CreateMultiSpawnObjectPool<T>(string name, int capacity, float expireTime) where T : AObject
        {
        ...
        /// <param name="expireTime">对象池对象过期秒数。</param>
        /// <returns>要创建的允许多次获取的对象池。</returns>
        public AObjectPool CreateMultiSpawnObjectPool(Type objectType, string name, int capacity, float expireTime)
        {
        ...
        /// <param name="priority">对象池的优先级。</param>
        /// <returns>要创建的允许多次获取的对象池。</returns>
        public IObjectPool<T> CreateMultiSpawnObjectPool<T>(string name, int capacity, int priority) where T : AObject
        {
        ...
        /// <param name="priority">对象池的优先级。</param>
        /// <returns>要创建的允许多次获取的对象池。</returns>
        public AObjectPool CreateMultiSpawnObjectPool(Type objectType, string name, int capacity, int priority)
        {
        ...
        /// <param name="priority">对象池的优先级。</param>
        /// <returns>要创建的允许多次获取的对象池。</returns>
        public IObjectPool<T> CreateMultiSpawnObjectPool<T>(string name, float expireTime, int priority) where T : AObject
        {
        ...
        /// <param name="priority">对象池的优先级。</param>
        /// <returns>要创建的允许多次获取的对象池。</returns>
        public AObjectPool CreateMultiSpawnObjectPool(Type objectType, string name, float expireTime, int priority)
        {
        ...
        /// <param name="priority">对象池的优先级。</param>
        /// <returns>要创建的允许多次获取的对象池。</returns>
        public IObjectPool<T> CreateMultiSpawnObjectPool<T>(int capacity, float expireTime, int priority) where T : AObject
        {
        ...
        /// <param name="priority">对象池的优先级。</param>
        /// <returns>要创建的允许多次获取的对象池。</returns>
        public AObjectPool CreateMultiSpawnObjectPool(Type objectType, int capacity, float expireTime, int priority)
        {
        ...
        /// <param name="priority">对象池的优先级。</param>
        /// <returns>要创建的允许多次获取的对象池。</returns>
        public IObjectPool<T> CreateMultiSpawnObjectPool<T>(string name, int capacity, float expireTime, int priority) where T : AObject
        {
        ...
        /// <param name="priority">对象池的优先级。</param>
        /// <returns>要创建的允许多次获取的对象池。</returns>
        public AObjectPool CreateMultiSpawnObjectPool(Type objectType, string name, int capacity, float expireTime, int priority)
        {
        ...
        /// <param name="priority">对象池的优先级。</param>
        /// <returns>要创建的允许多次获取的对象池。</returns>
        public IObjectPool<T> CreateMultiSpawnObjectPool<T>(string name, float autoReleaseInterval, int capacity, float expireTime, int priority) where T : AObject
        {
        ...
        /// <param name="priority">对象池的优先级。</param>
        /// <returns>要创建的允许多次获取的对象池。</returns>
        public AObjectPool CreateMultiSpawnObjectPool(Type objectType, string name, float autoReleaseInterval, int capacity, float expireTime, int priority)
        {
        ...
        public bool DestroyObjectPool<T>() where T : AObject
        {
        ...
        /// <returns>是否销毁对象池成功。</returns>
        public bool DestroyObjectPool<T>(string name) where T : AObject
        {
        ...
        /// <returns>是否销毁对象池成功。</returns>
        public bool DestroyObjectPool<T>(IObjectPool<T> objectPool) where T : AObject
        {
            if (objectPool == null)
            {
        ...
        /// <param name="objectPool">要销毁的对象池。</param>
        /// <returns>是否销毁对象池成功。</returns>
        public bool DestroyObjectPool(AObjectPool objectPool)
        {
            if (objectPool == null)
            {
                throw new Exception("Object pool is invalid.");
        ...
        public void Release()
        {
            ...
            foreach (AObjectPool objectPool in m_CachedAllObjectPools)
            {
                objectPool.Release();
            }
        }
        ...
        private AObjectPool InternalGetObjectPool(TypeNamePair typeNamePair)
        {
            AObjectPool objectPool = null;
        ...
        private IObjectPool<T> InternalCreateObjectPool<T>(string name, bool allowMultiSpawn, float autoReleaseInterval, int capacity, float expireTime, int priority) where T : AObject
        {
        ...
        private AObjectPool InternalCreateObjectPool(Type objectType, string name, bool allowMultiSpawn, float autoReleaseInterval, int capacity, float expireTime, int priority)
        {
            if (objectType == null)
            {
                throw new Exception("Object type is invalid.");
            ...
            AObjectPool objectPool = (AObjectPool)Activator.CreateInstance(objectPoolType, name, allowMultiSpawn, autoReleaseInterval, capacity, expireTime, priority);
            m_ObjectPools.Add(typeNamePair, objectPool);
            return objectPool;
        }
        ...
        private static int ObjectPoolComparer(AObjectPool a, AObjectPool b)
        {
